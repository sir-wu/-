...
<div>
  ...
  <el-row class="main" :gutter="20">
      <el-col :span="6">
  <el-button class="button" type="primary" @click="dialogFormVisible = true"> <i class="el-icon-edit"></i>新增专栏</el-button>
</el-col>
 <el-col :span="12">
 ...
 <el-table :data="tableData" style="width: 100%" border v-loading="listLoading">
      ...
      <el-table-column  label="专栏内容" width="500">
      ...
      >
      <template slot-scope="{row}">
    <span :style="{color:[row.isend ? 'red' : 'black' ] }" >{{ row.isend ? "连载中" :"已完结"  }}</span>
    </template>
      </el-table-column>
      <el-table-column
      prop="sub_count"
    ...
    <template slot-scope="{row}">
      ...
      <el-table-column prop="try" label="操作" align="center" fixed-width width="300px">
           <template slot-scope="{row,$index}">
          <el-button type="warning" size="mini" @click="goDetail(row)">
            目录
          </el-button>
